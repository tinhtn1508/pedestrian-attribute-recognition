...
'''
Refer to https://github.com/Megvii-Nanjing/ML-GCN/blob/master/models.py
'''
...
class GCNResnet(nn.Module):
    def __init__(self, model, num_classes, in_channel=26, t=0, adj_file=None):
        ...
        self.gc1 = GraphConvolution(in_channel, 300)
        self.gc2 = GraphConvolution(300, 1024)
